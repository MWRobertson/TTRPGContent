...
[TEMPLATE-NewNaturalDanger](TEMPLATE_NewNaturalDanger) This template is used to generate two types of notes - Hazards or Dangerous Terrain. <br>
[TEMPLATE-NewNPC](TEMPLATE_NewNPC) This template is used to generate NPC notes. <br>
[TEMPLATE-NewObstacle](TEMPLATE_NewObstacle) This template is used to generate notes pertaining to Obstacles in the party's path. <br>
[TEMPLATE-NewTrap](TEMPLATE_NewTrap) This template is used to generate notes about Traps. <br>
